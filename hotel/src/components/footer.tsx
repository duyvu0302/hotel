...
const policies = ["Chính sách đặt phòng", "Chính sách hủy phòng", "Chính sách bảo mật"];
    ...
    <footer className="bg-ink text-white/70">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li className="flex items-center gap-2.5">
              ...
              <a href={callHref} className="hover:text-gold">{site.phoneDisplay}</a>
            </li>
            <li className="flex items-center gap-2.5">
      ...
      <div className="border-t border-white/10">
        <div className="container-px flex flex-col items-center justify-between gap-2 py-6 text-xs text-white/50 sm:flex-row">
          ...
          <p>Thiết kế theo phong cách Luxury Resort.</p>
        </div>
      </div>
    </footer>
  );
